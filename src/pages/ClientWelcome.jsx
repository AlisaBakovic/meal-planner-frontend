      ...
      <section className="relative flex items-center min-h-screen px-6 sm:px-8 lg:px-24 overflow-visible pt-32 pb-20">
        ...
        <div className="relative z-20 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-10">
            ...
            <button className="w-full sm:w-auto rounded-full border border-[#ffb84d]/30 bg-white/40 backdrop-blur-xl px-7 py-4 text-[#ff944d] font-medium hover:bg-white/60 transition-all">
              Explore Platform
            </button>
          </div>
        </div>
