              ...
              <div className="mt-8 space-y-5">
                <div>
                  <div className="flex justify-between mb-2">
                    <p className="text-[#5f6f66] text-sm">Protein</p>

                    <p className="text-[#1f2937] text-sm font-semibold">120g</p>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <p className="text-[#5f6f66] text-sm">Carbs</p>

                    <p className="text-[#1f2937] text-sm font-semibold">180g</p>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <p className="text-[#5f6f66] text-sm">Water</p>

                    <p className="text-[#1f2937] text-sm font-semibold">2.4L</p>
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          className="cursor-pointer rounded-2xl bg-[#1f2937] px-5 py-3 text-sm text-white hover:opacity-90 transition-all"
                        >
                          View
                        </button>
                      </div>
          ...
          <div className="xl:col-span-4">
            <div className="rounded-[36px] border border-white/30 bg-gradient-to-br from-[#ffedd5]/80 to-[#dcfce7]/70 backdrop-blur-2xl p-7 shadow-[0_10px_40px_rgba(255,140,80,0.06)]">
              ...
              <div className="mt-7 rounded-3xl border border-white/30 bg-white/50 p-6">
                <p className="text-[#7f8b84] text-sm">Scheduled Session</p>
