function About({ scrollY }) {
  return (
    <div className="w-full py-32 bg-[url('/picture/Pattern.jpg')] bg-cover bg-center">
      ...
      >
        <h2 className="text-3xl font-semibold mb-3">About MealMap</h2>
        ...
        <div className="bg-[rgb(137,91,178)] backdrop-blur-md rounded-full px-6 flex items-center justify-center">
          ...
          >
            MealMap is a modern meal planning platform designed for coaches and
            trainers. It helps you create structured nutrition plans, manage
            your clients, and streamline your workflow — all in one place.
          </p>
        </div>
      </div>
    </div>
